...
public interface PrenotazioneRepository extends JpaRepository<Prenotazione, Long> {
    ...
    @Query("SELECT CASE WHEN COUNT(p) > 0 THEN true ELSE false END FROM Prenotazione p WHERE p.postazione.postazioneId = :postazioneId AND p.dataPrenotazione = :dataPrenotazione")
